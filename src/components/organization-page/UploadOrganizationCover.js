...
import { updateCoverPicture, updateOrganizationCover, updateProfilePicture } from "../../api/app";
import { LoadingButton } from "@mui/lab";

export default function UploadOrganizationCover(props) {
    ...
    const saveProfile = () => {
        ...
        const uploadPhoto = async (croppedImage) => {
            if (cropData) {
                setLoading(() => true)
                const res = await updateOrganizationCover(croppedImage, props.id)
                setLoading(() => false)
